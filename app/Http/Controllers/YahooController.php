...
class YahooController extends Controller
{
    public function index(){
		...
		$consumer_data['test']['key'] = 'dj0yJmk9YmhVUmhUVlFCWkxkJmQ9WVdrOU5WRnBhRlZuWldJbWNHbzlNQT09JnM9Y29uc3VtZXJzZWNyZXQmc3Y9MCZ4PTJh';
		$consumer_data['test']['secret'] = '06481a74c2779d13921d0165ff94eeead7dd804f';
		...
		$token_file_name = 'yahoo/oauth_data_token_storage_' . $consumer_key . '.out';
    ...
    public function apiCheck(){
    	...
    	$consumer_key = 'dj0yJmk9YmhVUmhUVlFCWkxkJmQ9WVdrOU5WRnBhRlZuWldJbWNHbzlNQT09JnM9Y29uc3VtZXJzZWNyZXQmc3Y9MCZ4PTJh';
		$consumer_secret = '06481a74c2779d13921d0165ff94eeead7dd804f';
		$o = new OAuth( $consumer_key, $consumer_secret,
		                OAUTH_SIG_METHOD_HMACSHA1,
		                OAUTH_AUTH_TYPE_URI );
		$url = 'https://fantasysports.yahooapis.com/fantasy/v2/players;player_keys=223.p.5479';
