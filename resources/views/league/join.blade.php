							...
							<div class="col-md-9">
								...
								<div class="form-group">
									<select name="team_id" id="teamId">
										<option value="" style="background-color: black;">Select Team</option>
										@if(isset($league->teams))
										@php $index = 0; @endphp
										@foreach($league->teams as $team)
										<option style="background-color: black;" value="{{$team->id}}" data-team_name="{{$team->team_name}}">Pick #{{++$index}} Team: {{$team->team_name}}</option>
										@endforeach
										@endif
									</select>
								</div>
