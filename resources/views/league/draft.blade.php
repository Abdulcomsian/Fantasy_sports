                                                ...
                                                <li class="list-inline-item">
                                                    <div class="time">
                                                                ...
                                                                <span class="clock"><button><i
                                                                    ...
                                                                    <div class="time_duration">
                                                                        <form id="timerForm">
                                                                            ...
                                                                            <p id="demo"></p>
                                                                            @php
                                                                            $currentDuration = explode(":",
                                                                            $league->timer_value);
                                                                            @endphp
                                                                            <div class="form-group">
                                                                                <span>Hours:</span> <input name="hours"
                                                                                    type="number" class="timer"
                                                        ...
                                                        <div class="clock">
                                                            ...
                                                            $timer = ($league->remaining_timer) ?
                                                            $league->remaining_timer : $league->timer_value;
                                                            $timer = explode(":", $timer);
                                                            if($timer[0] > 0){
                                ...
                                for($i=0;$i<$max;$i++) { @endphp <tr>
                                    <td>
                                        <div style="align-item:2px">
                                            <p style="margin:0px;">
                                                {{$data[$i]->round_number ?? ''}}.{{$data[$i]->round_order ?? ''}}</p>
                                        </div>
                                    </td>
                    </tr>
                    @php } @endphp
  ...
  <table class="table" style="margin-bottom:0px;">
    ...
    <tbody class="tbl-bdy-clr">
        ...
        <tr>
            <td></td>
            @foreach($rounds as $round)
            <td data-round_id="{{ $round->id }}">
                {{ (isset($round->player) && isset($round->player->last_name)) ? $round->player->last_name : '' }}</td>
            @endforeach
            <td></td>
        </tr>
        @endforeach
                                ...
                                <div class="select_draft draft_round">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group drft-plr">
                                                <label>Round</label>
                                                <input id="editkeeperlistteamid" type="hidden"
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.get_round_order.length > 1) {
                        list =
                            '<label>Pick</label><select id="roundorder" class="form-control" style="width:100px;background:black;color:white;padding:9px;height:44px">';
                        for (i = 0; i < res.get_round_order.length; i++) {
                            list += '<option value=' + res.get_round_order[i].round_order + ' selected>' +
                                res.get_round_order[i].round_order + '</option>';
                        }
                        list += '</select>';
                ...
                success: function (res) {
                    ...
                    if (res.length > 1) {
                        ...
                        for (i = 0; i < res.length; i++) {
                            list += '<option value=' + res[i].round_order + ' selected>' + res[i]
                                .round_order + '</option>';
                        }
                        list += '</select>';
                        $("#roundappend").html(list);
