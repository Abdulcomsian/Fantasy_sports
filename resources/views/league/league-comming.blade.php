            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="listDiv">
                            <ul>
                                <li><p><img src="{{asset('images/right-angle.png')}}" alt="" class="img-fluid"></p> <p>Multiple draft boards, for multiple leagues, no matter the platform</p></li>
                                <li><p><img src="{{asset('images/right-angle.png')}}" alt="" class="img-fluid"></p> <p>Designate Keepers and keeper Values</p></li>
                                <li><p><img src="{{asset('images/right-angle.png')}}" alt="" class="img-fluid"></p> <p>Fills off season gaps that active leagues require during the year, from Draft Lottery Simulation to Live Draft</p></li>
                                <li><p><img src="{{asset('images/right-angle.png')}}" alt="" class="img-fluid"></p> <p>Specifically designed for active keeper leagues where transactions and management is required by the commish</p></li>
                                <li><p><img src="{{asset('images/right-angle.png')}}" alt="" class="img-fluid"></p> <p>Create a one stop shop for off season business</p></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6">
